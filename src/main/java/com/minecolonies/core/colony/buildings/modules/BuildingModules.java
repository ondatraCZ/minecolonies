...
public class BuildingModules
{
    ...
    public static final BuildingEntry.ModuleProducer<GuardBuildingModule,CombinedHiringLimitModuleView> DRUID_BARRACKS_WORK  = new BuildingEntry.ModuleProducer<>(
      ...
      () -> CombinedHiringLimitModuleView::new);
    public static final BuildingEntry.ModuleProducer<GuardBuildingModule,CombinedHiringLimitModuleView> GUNNER_BARRACKS_WORK = new BuildingEntry.ModuleProducer<>(
      "gunner_barracks_work", () -> new GuardBuildingModule(ModGuardTypes.gunner.get(), true,ISchematicProvider::getBuildingLevel), () -> CombinedHiringLimitModuleView::new);
    ...
    public static final BuildingEntry.ModuleProducer<GuardBuildingModule,CombinedHiringLimitModuleView> GUNNER_TOWER_WORK =
            new BuildingEntry.ModuleProducer<>("gunner_tower_work", () -> new GuardBuildingModule(ModGuardTypes.gunner.get(), true, (b) -> 1), () -> CombinedHiringLimitModuleView::new);
