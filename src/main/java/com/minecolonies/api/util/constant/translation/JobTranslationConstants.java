...
public class JobTranslationConstants
{
    ...
    @NonNls
    public static final String JOB_GUNNER = "com.minecolonies.job.gunner";
    ...
    @NonNls
    public static final String JOB_GUNNER_BUTTON  = "com.minecolonies.coremod.gui.workerhuts.gunner";
